        ...
        {stage === "error" ? (
          <div className="adj-actions">
            <p className="adj-explain">
              ...
              Nothing moved: the escrow is untouched and the photograph was not stored.
              Sending it again picks a fresh leader.
            </p>
          ...
          <p className="adj-explain">
            ...
            a minute or two. Leaving this page does not cancel it, and the verdict lands on
            the specimen either way.
          </p>
        )}
      </div>
    </div>
